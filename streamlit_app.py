# streamlit_app.py
# -*- coding: utf-8 -*-
# xray-steps-parser v1.4 (+ strict column matching & Jira-ready headers)
...
- STRICT matching for multiple columns (Labels, Pre-Conditions) to prevent field mixing
...
def get_strict_cols(cols: List[str], needle: str) -> List[str]:
    ...
    Prevents matching unrelated fields like "Strict Labels" or "Test Labels".
    """
    needle_low = needle.lower()
    base_col = None
    for c in cols:
